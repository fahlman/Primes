...
if mode=='timing':
 ...
 assert assembly['control']==control and assembly['harness_revision']==harness
 assert assembly['wrapper_sha256']==sha(Path(__file__).with_name('complete-assembly-v1.py'))
 assert assembly['assembly_runner_sha256']==hashlib.sha256(frozen).hexdigest()
 ...
 assert review['control']==control and review['assembly_sha256']==assembly['assembly_sha256']
