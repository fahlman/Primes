...
CANDIDATE = 'b992595413ec577a666ed0e79ba0ab9c8e836463'
ROOT = REPO / 'experiments/swift'
BUILD = ROOT / '.build/storage-layout-b992595-checks-2'
EVIDENCE = ROOT / 'storage-layout-evidence/b992595-checks-2'
...
def main():
    ...
    try:
        ...
        with TimingLock('Codex storage-layout b992595 serial correctness and assembly verification'):
            ...
            try:
                ...
                record['status'] = 'passed_correctness_pending_assembly_review'
