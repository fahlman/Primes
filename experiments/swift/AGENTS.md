...
- The remaining runtime refactors were tested in one rotated session: shared helpers `06b24cb` measured 38.963242 µs versus adopted control `1d05221` at 38.989368 µs, with overlapping ranges; unified128 `9b2d9cb` measured 519.643315 µs. Both are rejected for adoption, unmerged, with branches and raw evidence preserved in PRs [#22](https://github.com/fahlman/Primes/pull/22) and [#23](https://github.com/fahlman/Primes/pull/23). No change to the adopted sieve. These are M4 / Swift 6.3.3 results; endpoint backup activity limits precision.
...
| Shared marking helpers | [PR #22](https://github.com/fahlman/Primes/pull/22), `06b24cb` | 0.038963 | Flat, overlapping ranges; tested and rejected; unmerged |
| Unified 128-bit dense handler for 3–111 | [PR #23](https://github.com/fahlman/Primes/pull/23), `9b2d9cb` | 0.519643 | Slower; tested and rejected; unmerged |
