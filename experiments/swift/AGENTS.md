...
- Use a committed report only for substantial explanations or comparisons across experiments. The README holds current usage and accepted results; this file holds stable working rules. Link to the PR and supporting report instead of maintaining duplicate experiment-status tables.
