...
- `swift/dense-small-factors`: cutoff 111, exact measured source `099e35a`, adopted through [PR #16](https://github.com/fahlman/Primes/pull/16) in merge commit `380a942`. It incorporates PR #14's 128-bit marking and proven-safe wrapping byte offsets; the earlier 127 cutoff is superseded. Integration preserves the reviewed sieve, generator, runner, observer and verifier bytes. It remains unchanged after the [PR #25 recurrence experiment](https://github.com/fahlman/Primes/pull/25), which was tested and rejected for adoption.
- User-requested [PR #25 repeat](reports/VectorRecurrenceRetest.md), same `616d0bd` candidate and `1d05221` control: 79.354072 versus 38.628090 µs, 2.054310 times as long and 40.725982 µs added. All six benchmark runs and sampled-condition checks passed, with every candidate trial slower. Retain rejection; both original and repeat evidence preserved separately.
...
| Runtime 128-bit recurrence for odd factors 65–111 | [PR #25](https://github.com/fahlman/Primes/pull/25), `616d0bd`; [report](reports/VectorRecurrenceReview.md) | 0.079825 | 2.0446x control duration; tested and rejected; unmerged, branch preserved |
| Runtime 128-bit recurrence: user-requested repeat | [PR #25](https://github.com/fahlman/Primes/pull/25), unchanged `616d0bd`; [retest](reports/VectorRecurrenceRetest.md) | 0.079354 | 2.0543x control duration; retain rejection, closed and unmerged; all six runs and monitoring checks passed |
