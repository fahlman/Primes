...
- PR #10 updates the seven-mode phase diagnostic to copy adopted B (`8f108f5`), with sparse cutoffs at 251 and 499. The normalized source check, correctness verification, independent review and fresh timings must pass before integration. Matching full output flags alone does not establish timing-code fidelity.
