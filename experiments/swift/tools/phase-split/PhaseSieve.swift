// Diagnostic copy of PrimeSieve.swift at 8f108f5 (adopted in 703dc12).
// Only three source substitutions follow this header: the class name, runSieve's
// throughFactor parameter, and the extra cutoff in its factor-discovery loop.
// All storage, marking, enumeration, and lifetime code is copied unchanged.
// Partial workloads are diagnostics, not qualifying complete sieve passes.
// Recheck the normalized copy against production whenever either file changes.
