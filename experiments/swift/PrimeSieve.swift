...
final class PrimeSieve {
    ...
    /// Dense marking on 64-bit words for odd factors 5 through 47. Together with the
    /// byte handler for 3, every odd value below 48 has a case, so no primality is
    /// assumed; the composite values 9, 15, 21, 25, 27, 33, 35, 39, and 45 never
    /// reach this function.
    private func markWordDenseMultiples(of p: Int) {
        ...
        default:
            preconditionFailure("Word-dense marking requires an odd factor from 5 to 47")
        }
