...
; %bb.0:
	...
	mov	w19, #3                         ; =0x3
	mov	x16, #-9223372036854775808      ; =0x8000000000000000
...
Lloh11:
	...
	movi.16b	v24, #36
	stp	q17, q16, [x29, #-128]          ; 32-byte Folded Spill
	stp	q19, q18, [sp, #128]            ; 32-byte Folded Spill
	stp	q23, q22, [sp, #96]             ; 32-byte Folded Spill
...
; %bb.20:                               ;   in Loop: Header=BB2_3 Depth=1
	...
	movi.16b	v24, #36
	ldp	q23, q22, [sp, #96]             ; 32-byte Folded Reload
	movi.16b	v21, #73
	movi.16b	v20, #146
	ldp	q19, q18, [sp, #128]            ; 32-byte Folded Reload
	ldp	q17, q16, [x29, #-128]          ; 32-byte Folded Reload
	mov	w2, #73                         ; =0x49
	mov	w1, #8                          ; =0x8
	mov	w0, #36                         ; =0x24
	mov	w17, #146                       ; =0x92
...
; %bb.30:                               ;   in Loop: Header=BB2_3 Depth=1
	add	x16, x19, x19, lsl #1
	adds	x12, x2, x16
	b.vs	LBB2_133
; %bb.31:                               ;   in Loop: Header=BB2_3 Depth=1
	adds	x14, x2, x19, lsl #2
	b.vs	LBB2_135
...
; %bb.38:                               ;   in Loop: Header=BB2_3 Depth=1
	stp	x8, x16, [sp, #48]              ; 16-byte Folded Spill
	asr	x23, x10, #3
	asr	x22, x13, #3
	asr	x0, x12, #3
	asr	x16, x14, #3
	...
	asr	x9, x9, #3
	cmp	x9, x1
	stp	x14, x12, [sp, #32]             ; 16-byte Folded Spill
	stp	x0, x16, [sp, #16]              ; 16-byte Folded Spill
	stp	x23, x22, [sp]                  ; 16-byte Folded Spill
	b.ge	LBB2_41
...
LBB2_89:                                ;   in Loop: Header=BB2_3 Depth=1
	mov	w2, #73                         ; =0x49
	ldp	x22, x11, [sp, #64]             ; 16-byte Folded Reload
	ldr	x8, [sp, #88]                   ; 8-byte Folded Reload
	orr	x8, x8, x9, lsl #3
LBB2_90:                                ;   Parent Loop BB2_3 Depth=1
                                        ; =>  This Inner Loop Header: Depth=2
	cmp	x8, x11
	b.ge	LBB2_1
...
LBB2_93:                                ;   in Loop: Header=BB2_3 Depth=1
	...
	ldr	x8, [sp, #88]                   ; 8-byte Folded Reload
	orr	x8, x8, x9, lsl #3
LBB2_94:                                ;   Parent Loop BB2_3 Depth=1
                                        ; =>  This Inner Loop Header: Depth=2
	cmp	x8, x11
	b.ge	LBB2_1
...
LBB2_108:                               ;   in Loop: Header=BB2_3 Depth=1
	sub	x11, x11, #3
LBB2_109:                               ;   Parent Loop BB2_3 Depth=1
                                        ; =>  This Inner Loop Header: Depth=2
	add	x12, x9, x10
	ldrb	w13, [x12]
	orr	w13, w13, w2
...
_objc_classes_$s10PrimeSwift0A5SieveCN:
	...
	.linker_option "-lswiftSynchronization"
	.linker_option "-lobjc"
