...
; %bb.0:
	...
	mov	w19, #3                         ; =0x3
	mov	x23, #-9223372036854775808      ; =0x8000000000000000
	mov	w24, #146                       ; =0x92
	mov	w25, #36                        ; =0x24
	mov	w26, #1                         ; =0x1
	mov	w27, #73                        ; =0x49
...
Lloh11:
	...
	movi.16b	v24, #36
	stp	x22, x20, [sp, #80]             ; 16-byte Folded Spill
	stur	q16, [x29, #-176]               ; 16-byte Folded Spill
	stp	q18, q17, [sp, #160]            ; 32-byte Folded Spill
	stp	q22, q19, [sp, #128]            ; 32-byte Folded Spill
...
; %bb.20:                               ;   in Loop: Header=BB2_3 Depth=1
	...
	movi.16b	v24, #36
	ldp	q23, q22, [sp, #112]            ; 32-byte Folded Reload
	movi.16b	v21, #73
	movi.16b	v20, #146
	ldp	q19, q18, [sp, #144]            ; 32-byte Folded Reload
	ldr	q17, [sp, #176]                 ; 16-byte Folded Reload
	ldur	q16, [x29, #-176]               ; 16-byte Folded Reload
	add	x19, x19, #2
	b	LBB2_2
...
; %bb.38:                               ;   in Loop: Header=BB2_3 Depth=1
	...
	asr	x10, x10, #3
	cmp	x10, x0
	stp	x6, x17, [sp, #56]              ; 16-byte Folded Spill
	stp	x2, x5, [sp, #40]               ; 16-byte Folded Spill
	stp	x3, x4, [sp, #24]               ; 16-byte Folded Spill
	stp	x1, x30, [sp, #8]               ; 16-byte Folded Spill
	b.ge	LBB2_41
; %bb.39:                               ;   in Loop: Header=BB2_3 Depth=1
	...
	add	x11, x21, x11
	add	x9, x21, x9
	stp	x9, x11, [x29, #-152]           ; 16-byte Folded Spill
	add	x9, x2, x8
	add	x28, x21, x9
	add	x9, x1, x8
	add	x22, x21, x9
...
LBB2_40:                                ;   Parent Loop BB2_3 Depth=1
	...
	mov	x7, x30
	add	x10, x10, x30
	ldur	x26, [x29, #-160]               ; 8-byte Folded Reload
	cmp	x10, x26
	b.lt	LBB2_40
...
; %bb.42:                               ;   in Loop: Header=BB2_3 Depth=1
	ldp	x13, x8, [sp, #32]              ; 16-byte Folded Reload
	add	x8, x21, x8
	ldp	x9, x11, [sp, #8]               ; 16-byte Folded Reload
	add	x9, x21, x9
	add	x11, x21, x11
	ldr	x12, [sp, #24]                  ; 8-byte Folded Reload
	add	x12, x21, x12
	add	x13, x21, x13
	ldp	x14, x15, [sp, #48]             ; 16-byte Folded Reload
	add	x14, x21, x14
	add	x15, x21, x15
	ldp	x22, x20, [sp, #80]             ; 16-byte Folded Reload
...
; %bb.58:                               ;   in Loop: Header=BB2_3 Depth=1
	...
	mov	w27, #73                        ; =0x49
	ldr	x0, [sp, #104]                  ; 8-byte Folded Reload
LBB2_59:                                ;   Parent Loop BB2_3 Depth=1
                                        ; =>  This Inner Loop Header: Depth=2
	ldrb	w16, [x21, x10]
	orr	w16, w16, #0x8
	strb	w16, [x21, x10]
...
; %bb.71:                               ;   in Loop: Header=BB2_3 Depth=1
	...
	add	x5, x21, x5
	add	x6, x21, x6
LBB2_72:                                ;   Parent Loop BB2_3 Depth=1
                                        ; =>  This Inner Loop Header: Depth=2
	mov	x30, x7
	ldrb	w7, [x21, x10]
	orr	w7, w7, #0x8
...
; %bb.87:                               ;   in Loop: Header=BB2_3 Depth=1
	...
	add	x5, x21, x5
	add	x6, x21, x6
LBB2_88:                                ;   Parent Loop BB2_3 Depth=1
                                        ; =>  This Inner Loop Header: Depth=2
	mov	x30, x7
	ldrb	w7, [x21, x10]
	orr	w7, w7, #0x80
...
LBB2_97:                                ;   in Loop: Header=BB2_3 Depth=1
	...
	cmp	x8, x17
	b.ge	LBB2_1
LBB2_98:                                ;   Parent Loop BB2_3 Depth=1
                                        ; =>  This Inner Loop Header: Depth=2
	and	x9, x8, #0x7
	asr	x10, x8, #3
	ldrb	w11, [x21, x10]
...
LBB2_107:                               ;   in Loop: Header=BB2_3 Depth=1
	...
	add	x14, x9, #3
	mov	x15, x13
LBB2_108:                               ;   Parent Loop BB2_3 Depth=1
                                        ; =>  This Inner Loop Header: Depth=2
	ldp	q1, q3, [x14, #16]
	ldr	q0, [x14]
...
; %bb.109:                              ;   in Loop: Header=BB2_3 Depth=1
	cmp	x12, x13
	b.eq	LBB2_112
LBB2_110:                               ;   in Loop: Header=BB2_3 Depth=1
	sub	x11, x11, #3
LBB2_111:                               ;   Parent Loop BB2_3 Depth=1
                                        ; =>  This Inner Loop Header: Depth=2
	add	x12, x9, x10
	ldrb	w13, [x12]
	orr	w13, w13, w27
...
LBB2_113:                               ;   in Loop: Header=BB2_3 Depth=1
	cmp	x10, x8
	b.hs	LBB2_22
LBB2_114:                               ;   Parent Loop BB2_3 Depth=1
                                        ; =>  This Inner Loop Header: Depth=2
	and	x11, x10, #0x7
	lsl	w11, w26, w11
	asr	x12, x10, #3
